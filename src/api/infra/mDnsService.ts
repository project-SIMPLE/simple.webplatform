import ciao, { type Responder, ServiceType } from "@homebridge/ciao";
...
export class mDnsService {
	...
	constructor(hostname?: string) {
		if (hostname) {
			...
			logger.warn(
				"If this domain doesn't work, make sure to properly configure Vite.js to supports this domain name too.",
			);
		}
