...
const StreamPlayerScreen = () => {
  ...
  // const [ws, setWs] = useState<WebSocket | null>(null); unused variable defining a websocket that is meant to control the display type
  // const [isWsConnected, setIsWsConnected] = useState<boolean>(false); of this component, to accomodate a GAMA display inside the app
  ...
  //this websocket is not required for now
  //we may also delete it, it creates instability for a feature that does not exist
  // nor is planned as of now
  // useEffect(() => {
